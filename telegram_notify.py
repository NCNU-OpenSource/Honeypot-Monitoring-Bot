...
async def send_photo_ip(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    subprocess.run(["python3","/home/cowrie/Real-time_Honeypot_Monitoring_Bot/graph_output.py"])
    photo_path = "/home/cowrie/Real-time_Honeypot_Monitoring_Bot/img/ip.png"
...
async def send_photo_username(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    subprocess.run(["python3","/home/cowrie/Real-time_Honeypot_Monitoring_Bot/graph_output.py"])
    photo_path = "/home/cowrie/Real-time_Honeypot_Monitoring_Bot/img/username.png"
    chat_id = update.effective_chat.id
...
async def send_photo_password(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    subprocess.run(["python3","/home/cowrie/Real-time_Honeypot_Monitoring_Bot/graph_output.py"])
    photo_path = "/home/cowrie/Real-time_Honeypot_Monitoring_Bot/img/password.png"
    chat_id = update.effective_chat.id
...
async def send_photo_user_pass(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    subprocess.run(["python3","/home/cowrie/Real-time_Honeypot_Monitoring_Bot/graph_output.py"])
    photo_path = "/home/cowrie/Real-time_Honeypot_Monitoring_Bot/img/user_pass.png"
    chat_id = update.effective_chat.id
...
async def send_result(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    command = "python3 /home/cowrie/Real-time_Honeypot_Monitoring_Bot/text_output.py"
